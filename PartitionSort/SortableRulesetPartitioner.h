...
class SortableRulesetPartitioner {
 ...
 public:
  ...
  FastGreedyFieldSelectionTwoIterations(const std::vector<Rule>& rules);

  static std::pair<std::vector<Rule>, std::vector<int>>
  FastGreedyFieldSelection(const std::vector<Rule>& rules);
 ...
 private:
  ...
  /*Helper For GrInd */
  static std::pair<std::vector<SortableRulesetPartitioner::part>, bool>
  IsThisPartitionSortable(const part& apartition, int current_field);
  static std::pair<std::vector<SortableRulesetPartitioner::part>, bool>
  IsEntirePartitionSortable(const std::vector<part>& all_partition,
                            int current_field);
  ...
  /*Helper For MISF*/
  static std::pair<std::vector<Rule>, std::vector<int>>
  MaximumIndependentSetAllFields(const std::vector<Rule>& rules);
  ...
  static int ComputeMaxIntersectionRecursive(
...
class SortableRuleset {
 public:
  ...
  int size() const { return rule_list.size(); }
